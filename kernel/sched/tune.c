...
static u64
__maybe_unused sched_boost_override_read(struct cgroup_subsys_state *css,
			struct cftype *cft)
{
...
static int __maybe_unused sched_boost_override_write(struct cgroup_subsys_state *css,
